  ...
  return (
    <html lang="en">
      ...
      <body className={cx(sfPro.variable, inter.variable)}>
        ...
        <main className="flex bg-gradient-to-tl from-blue-700 via-purple-400 to-indigo-500 min-h-screen w-full flex-col items-center justify-center pt-16 relative">
          {children}
        </main>
        <Analytics />
      </body>
