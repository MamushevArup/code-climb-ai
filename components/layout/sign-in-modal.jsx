          ...
          <div className="flex min-h-full items-center justify-center">
            ...
            >
              <Dialog.Panel className="w-full  overflow-hidden shadow-xl md:max-w-md md:rounded-2xl md:border md:border-gray-200 transition-all">
                <div className="flex flex-col bg-gradient-to-tl from-blue-700 via-purple-400 to-indigo-500 items-center justify-center space-y-3 px-4 py-6 pt-8 text-center md:px-16">
                  <Image
                    src={Code_Climb}
                    alt="Logo"
